...
from .models import PaymentGateway, PaymentTransaction, PaystackTransaction, WebhookEvent, FlutterwaveTransaction
...
# class PaymentTransactionAdmin(admin.ModelAdmin):
#     list_display = [
#         'id', 'user', 'gateway', 'transaction_type', 'amount', 
#         'currency', 'status', 'created_at'
#     ]
#     list_filter = [
#         'gateway', 'transaction_type', 'status', 'currency', 'created_at'
#     ]
#     search_fields = [
#         'user__email', 'gateway_reference', 'internal_reference'
#     ]
#     readonly_fields = ['id', 'internal_reference', 'created_at', 'updated_at']
#     inlines = [PaystackTransactionInline, FlutterwaveTransactionInline]
#     date_hierarchy = 'created_at'
...
# class PaystackTransactionAdmin(admin.ModelAdmin):
#     list_display = [
#         'transaction', 'paystack_reference', 'authorization_url', 
#         'recipient_code', 'created_at'
#     ]
#     search_fields = ['paystack_reference', 'recipient_code']
#     readonly_fields = ['created_at']
